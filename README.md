...
Contributions welcome! Read the [contribution guidelines](https://github.com/coq-community/awesome-coq/blob/master/CONTRIBUTING.md) ⭐ 393 | 🐛 10 | 📅 2026-06-05 first.
...
* [Fiat](https://github.com/mit-plv/fiat) ⭐ 160 | 🐛 2 | 🌐 Rocq Prover | 📅 2026-06-19 - Mostly automated synthesis of correct-by-construction programs.
* [ConCert](https://github.com/AU-COBRA/ConCert) ⭐ 128 | 🐛 7 | 🌐 Rocq Prover | 📅 2026-08-13 - Framework for smart contract testing and verification featuring a code extraction pipeline to several smart contract languages.
...
* [Hoare Type Theory](https://github.com/imdea-software/htt/) ⭐ 88 | 🐛 0 | 🌐 Rocq Prover | 📅 2026-08-06 - A shallow embedding of sequential separation logic formulated as a type theory.
* [CoqEAL](https://github.com/CoqEAL/CoqEAL) ⭐ 75 | 🐛 8 | 🌐 Rocq Prover | 📅 2026-07-23 - Framework to ease change of data representations in proofs.
...
* [VCFloat](https://github.com/VeriNum/vcfloat) ⭐ 34 | 🐛 6 | 🌐 Rocq Prover | 📅 2026-06-18 - Framework for verifying C programs with floating-point computations.
...
* [VsCoq](https://github.com/coq-community/vscoq) ⭐ 459 | 🐛 176 | 🌐 OCaml | 📅 2026-08-15 - Language server and extension for the Visual Studio Code and VSCodium editors.
* [VsCoq Legacy](https://github.com/coq-community/vscoq/tree/vscoq1) ⭐ 459 | 🐛 176 | 🌐 OCaml | 📅 2026-08-15 - Backwards-compatible extension for the Visual Studio Code and VSCodium editors using Coq's legacy XML protocol.
...
* [Coqtail](https://github.com/whonore/Coqtail) ⭐ 325 | 🐛 39 | 🌐 Python | 📅 2026-08-02 - Interface for Coq based on the Vim text editor.
* [Coq LSP](https://github.com/ejgallego/coq-lsp) ⭐ 208 | 🐛 149 | 🌐 OCaml | 📅 2026-07-27 - Language server and extension for the Visual Studio Code and VSCodium editors with custom document checking engine.
...
* [Tree Sitter Rocq](https://github.com/lamg/tree-sitter-rocq) ⭐ 5 | 🐛 0 | 🌐 Rocq Prover | 📅 2025-08-17 - Partial Rocq tree-sitter grammar useful for syntax highlighting in text editors like [Helix](https://github.com/helix-editor/helix) ⭐ 45,826 | 🐛 1,606 | 🌐 Rust | 📅 2026-08-11, but not recommended for full parsing of Rocq code.
...
* [Interaction Trees](https://github.com/DeepSpec/InteractionTrees) ⭐ 256 | 🐛 31 | 🌐 Rocq Prover | 📅 2026-06-12 - Library for representing recursive and impure programs.
...
* [Formalised Undecidable Problems](https://github.com/uds-psl/coq-library-undecidability) ⭐ 141 | 🐛 19 | 🌐 Rocq Prover | 📅 2026-06-24 - Library of undecidable problems and reductions between them.
* [ExtLib](https://github.com/coq-community/coq-ext-lib) ⭐ 136 | 🐛 20 | 🌐 Rocq Prover | 📅 2026-04-28 - Collection of theories and plugins that may be useful in other Coq developments.
...
* [Coq record update](https://github.com/tchajed/coq-record-update) ⭐ 49 | 🐛 7 | 🌐 Rocq Prover | 📅 2026-06-08 - Library which provides a generic way to update Coq record fields.
...
* [Algebra Tactics](https://github.com/math-comp/algebra-tactics) ⭐ 39 | 🐛 15 | 🌐 Rocq Prover | 📅 2026-04-03 - Ring and field tactics for Mathematical Components.
...
* [FCSL-PCM](https://github.com/imdea-software/fcsl-pcm) ⭐ 36 | 🐛 0 | 🌐 Rocq Prover | 📅 2026-08-06 - Formalization of partial commutative monoids as used in verification of pointer-manipulating programs.
* [Simple IO](https://github.com/Lysxia/coq-simple-io) ⭐ 34 | 🐛 4 | 🌐 Rocq Prover | 📅 2026-06-03 - Input/output monad with user-definable primitive operations.
* [Mczify](https://github.com/math-comp/mczify) ⭐ 31 | 🐛 5 | 🌐 Rocq Prover | 📅 2026-07-29 - Library enabling Micromega arithmetic solvers to work when using Mathematical Components number definitions.
...
* [Hahn](https://github.com/vafeiadis/hahn) ⭐ 29 | 🐛 8 | 🌐 Coq | 📅 2024-06-25 - Library for reasoning on lists and binary relations.
...
* [CertiGraph](https://github.com/Salamari/CertiGraph) ⭐ 19 | 🐛 5 | 🌐 Rocq Prover | 📅 2026-07-21 - Library for reasoning about directed graphs and their embedding in separation logic.
...
* [Coq Platform](https://github.com/coq/platform) ⭐ 242 | 🐛 68 | 🌐 Shell | 📅 2026-07-30 - Curated collection of packages to support Coq use in industry, education, and research.
* [Coq Nix Toolbox](https://github.com/coq-community/coq-nix-toolbox) ⭐ 56 | 🐛 47 | 🌐 Nix | 📅 2026-08-12 - Nix helper scripts to automate local builds and continuous integration for Coq.
...
* [Docker-MathComp](https://github.com/math-comp/docker-mathcomp) ⭐ 6 | 🐛 5 | 🌐 Dockerfile | 📅 2026-07-24 - Docker images for many combinations of versions of Coq and the Mathematical Components library.
...
* [MetaCoq](https://github.com/MetaCoq/metacoq) ⭐ 549 | 🐛 95 | 🌐 Rocq Prover | 📅 2026-08-10 - Project formalizing Coq in Coq and providing tools for manipulating Coq terms and developing certified plugins.
* [QuickChick](https://github.com/QuickChick/QuickChick) ⭐ 291 | 🐛 92 | 🌐 Rocq Prover | 📅 2026-07-07 - Plugin for randomized property-based testing.
* [CoqHammer](https://github.com/lukaszcz/coqhammer) ⭐ 244 | 🐛 9 | 🌐 OCaml | 📅 2026-08-08 - General-purpose automated reasoning hammer tool that combines learning from previous proofs with the translation of problems to automated provers and the reconstruction of found proofs.
* [Equations](https://github.com/mattam82/Coq-Equations) ⭐ 238 | 🐛 103 | 🌐 Rocq Prover | 📅 2026-07-02 - Function definition package for Coq.
* [Coq-Elpi](https://github.com/LPCIC/coq-elpi) ⭐ 194 | 🐛 129 | 🌐 OCaml | 📅 2026-08-12 - Extension framework based on λProlog providing an extensive API to implement commands and tactics.
* [SMTCoq](https://github.com/smtcoq/smtcoq) ⭐ 169 | 🐛 42 | 🌐 OCaml | 📅 2026-07-28 - Tool that checks proof witnesses coming from external SAT and SMT solvers.
* [Hierarchy Builder](https://github.com/math-comp/hierarchy-builder) ⭐ 105 | 🐛 125 | 🌐 Rocq Prover | 📅 2026-07-24 - Collection of commands for declaring Coq hierarchies based on packed classes.
* [Unicoq](https://github.com/unicoq/unicoq) ⭐ 60 | 🐛 11 | 🌐 OCaml | 📅 2026-06-26 - Plugin that replaces the existing unification algorithm with an enhanced one.
* [Mtac2](https://github.com/Mtac2/Mtac2) ⭐ 57 | 🐛 70 | 🌐 Rocq Prover | 📅 2026-07-01 - Plugin adding typed tactics for backward reasoning.
* [Waterproof proof language](https://github.com/impermeable/coq-waterproof) ⭐ 51 | 🐛 27 | 🌐 Rocq Prover | 📅 2026-08-12 - Plugin providing a language for writing proof scripts in a style that resembles non-mechanized mathematical proof.
* [Paramcoq](https://github.com/coq-community/paramcoq) ⭐ 44 | 🐛 10 | 🌐 OCaml | 📅 2026-06-02 - Plugin to generate parametricity translations of Coq terms.
* [AAC Tactics](https://github.com/coq-community/aac-tactics) ⭐ 37 | 🐛 7 | 🌐 OCaml | 📅 2026-05-11 - Tactics for rewriting universally quantified equations, modulo associativity and commutativity of some operator.
...
* [Name the Biggest Number](https://github.com/codyroux/name-the-biggest-number) ⭐ 67 | 🐛 0 | 🌐 Coq | 📅 2022-09-13 - Repository for submitting proven contenders for the title of biggest number in Coq.
...
* [Sail](https://github.com/rems-project/sail) ⭐ 917 | 🐛 302 | 🌐 Sail | 📅 2026-08-13 - Tool for specifying instruction set architecture (ISA) semantics of processors and generating Coq definitions.
* [Cosette](https://github.com/uwdb/Cosette) ⭐ 686 | 🐛 27 | 🌐 Lean | 📅 2024-12-18 - Automated solver for reasoning about SQL query equivalences.
* [Ott](https://github.com/ott-lang/ott) ⭐ 420 | 🐛 39 | 🌐 OCaml | 📅 2026-03-10 - Tool for writing definitions of programming languages and calculi that can be translated to Coq.
* [Alectryon](https://github.com/cpitclaudel/alectryon) ⭐ 322 | 🐛 18 | 🌐 HTML | 📅 2026-06-02 - Collection of tools for writing technical documents that mix Coq code and prose.
...
* [coq-dpdgraph](https://github.com/coq-community/coq-dpdgraph) ⭐ 102 | 🐛 28 | 🌐 OCaml | 📅 2026-04-16 - Tool for building dependency graphs between Coq objects.
...
* [coq-tools](https://github.com/JasonGross/coq-tools) ⭐ 49 | 🐛 59 | 🌐 Python | 📅 2026-07-30 - Scripts for manipulating Coq developments.
  * [`find-bug.py`](https://github.com/JasonGross/coq-tools/blob/master/find-bug.py) ⭐ 49 | 🐛 59 | 🌐 Python | 📅 2026-07-30 - Automatically minimizes source files producing an error, creating small test cases for Coq bugs.
  * [`absolutize-imports.py`](https://github.com/JasonGross/coq-tools/blob/master/absolutize-imports.py) ⭐ 49 | 🐛 59 | 🌐 Python | 📅 2026-07-30 - Processes source files to make loading of dependencies robust against shadowing of file names.
  * [`inline-imports.py`](https://github.com/JasonGross/coq-tools/blob/master/inline-imports.py) ⭐ 49 | 🐛 59 | 🌐 Python | 📅 2026-07-30 - Creates stand-alone source files from developments by inlining the loading of all dependencies.
  * [`minimize-requires.py`](https://github.com/JasonGross/coq-tools/blob/master/minimize-requires.py) ⭐ 49 | 🐛 59 | 🌐 Python | 📅 2026-07-30 - Removes loading of unused dependencies.
  * [`move-requires.py`](https://github.com/JasonGross/coq-tools/blob/master/move-requires.py) ⭐ 49 | 🐛 59 | 🌐 Python | 📅 2026-07-30 - Moves all dependency loading statements to the top of source files.
  * [`move-vernaculars.py`](https://github.com/JasonGross/coq-tools/blob/master/move-vernaculars.py) ⭐ 49 | 🐛 59 | 🌐 Python | 📅 2026-07-30 - Lifts many vernacular commands and inner lemmas out of proof script blocks.
  * [`proof-using-helper.py`](https://github.com/JasonGross/coq-tools/blob/master/proof-using-helper.py) ⭐ 49 | 🐛 59 | 🌐 Python | 📅 2026-07-30 - Modifies source files to include proof annotations for faster parallel proving.
...
* [Autosubst-ocaml](https://github.com/uds-psl/autosubst-ocaml) ⭐ 20 | 🐛 9 | 🌐 Coq | 📅 2026-07-02 - Tool that generates Coq code for handling binders in syntax, such as for renaming and substitutions.
* [Trakt](https://github.com/ecranceMERCE/trakt) ⭐ 17 | 🐛 2 | 🌐 Prolog | 📅 2026-07-27 - Generic goal preprocessing tool for proof automation tactics.
* [coq-scripts](https://github.com/JasonGross/coq-scripts) ⭐ 9 | 🐛 1 | 🌐 Rocq Prover | 📅 2026-05-04 - Scripts for dealing with Coq files, including tabulating proof times.
* [Rocqnavi](https://github.com/affeldt-aist/rocqnavi) ⭐ 4 | 🐛 14 | 🌐 OCaml | 📅 2026-08-12 - Fork of coq2html that adds indexes, clickable notations, Markdown and LaTeX formatting in comments, and more.
...
* [Homotopy Type Theory](https://github.com/HoTT/Coq-HoTT) ⭐ 1,403 | 🐛 135 | 🌐 Rocq Prover | 📅 2026-08-13 - Development of homotopy-theoretic ideas.
* [UniMath](https://github.com/UniMath/UniMath) ⭐ 1,019 | 🐛 152 | 🌐 Rocq Prover | 📅 2026-08-07 - Library which aims to formalize a substantial body of mathematics using the univalent point of view.
* [Category Theory in Coq](https://github.com/jwiegley/category-theory) ⭐ 805 | 🐛 752 | 🌐 Rocq Prover | 📅 2026-08-15 - Axiom-free formalization of category theory.
* [Analysis](https://github.com/math-comp/analysis) ⭐ 247 | 🐛 188 | 🌐 Rocq Prover | 📅 2026-08-14 - Library for classical real analysis compatible with Mathematical Components.
* [Four Color Theorem](https://github.com/coq-community/fourcolor) ⭐ 246 | 🐛 2 | 🌐 Rocq Prover | 📅 2026-07-17 - Formal proof of the Four Color Theorem, a landmark result of graph theory.
...
* [Infotheo](https://github.com/affeldt-aist/infotheo) ⭐ 76 | 🐛 24 | 🌐 Rocq Prover | 📅 2026-07-29 - Formalization of information theory and linear error-correcting codes.
* [Monae](https://github.com/affeldt-aist/monae) ⭐ 76 | 🐛 29 | 🌐 Rocq Prover | 📅 2026-07-21 - Monadic effects and equational reasoning.
* [Finmap](https://github.com/math-comp/finmap) ⭐ 51 | 🐛 16 | 🌐 Rocq Prover | 📅 2026-07-17 - Extension of Mathematical Components with finite maps, sets, and multisets.
* [Graph Theory](https://github.com/coq-community/graph-theory) ⭐ 45 | 🐛 3 | 🌐 Rocq Prover | 📅 2026-05-06 - Formalized graph theory results.
* [CoqPrime](https://github.com/thery/coqprime) ⭐ 44 | 🐛 1 | 🌐 Rocq Prover | 📅 2026-06-22 - Library for certifying primality using Pocklington and Elliptic Curve certificates.
* [Odd Order Theorem](https://github.com/math-comp/odd-order) ⭐ 37 | 🐛 4 | 🌐 Rocq Prover | 📅 2026-07-24 - Formal proof of the Odd Order Theorem, a landmark result of finite group theory.
* [Gaia](https://github.com/coq-community/gaia) ⭐ 31 | 🐛 1 | 🌐 Rocq Prover | 📅 2026-07-21 - Implementation of books from Bourbaki's Elements of Mathematics, including set theory and number theory.
...
* [Fiat-Crypto](https://github.com/mit-plv/fiat-crypto) ⭐ 839 | 🐛 186 | 🌐 Rocq Prover | 📅 2026-08-14 - Cryptographic primitive code generation.
* [Jasmin](https://github.com/jasmin-lang/jasmin) ⭐ 362 | 🐛 135 | 🌐 Rocq Prover | 📅 2026-08-13 - Formalized language and verified compiler for high-assurance and high-speed cryptography.
* [JSCert](https://github.com/jscert/jscert) ⭐ 208 | 🐛 8 | 🌐 Coq | 📅 2024-02-05 - Coq specification of ECMAScript 5 (JavaScript) with verified reference interpreter.
* [Verdi Raft](https://github.com/uwplse/verdi-raft) ⭐ 199 | 🐛 15 | 🌐 Coq | 📅 2023-12-08 - Implementation of the Raft distributed consensus protocol, verified in Coq using the Verdi framework.
* [CertiCoq](https://github.com/CertiCoq/certicoq) ⭐ 176 | 🐛 28 | 🌐 Rocq Prover | 📅 2026-07-22 - Verified compiler from Gallina, the internal language of Coq, down to CompCert's Clight language.
* [Ceramist](https://github.com/certichain/ceramist) ⭐ 125 | 🐛 0 | 🌐 Coq | 📅 2020-04-13 - Verified hash-based approximate membership structures such as Bloom filters.
* [WasmCert-Coq](https://github.com/WasmCert/WasmCert-Coq/) ⭐ 123 | 🐛 7 | 🌐 Rocq Prover | 📅 2026-06-18 - Formalization in Coq of the WebAssembly (aka Wasm) 1.0 specification.
* [RISC-V Specification in Coq](https://github.com/mit-plv/riscv-coq) ⭐ 118 | 🐛 9 | 🌐 Rocq Prover | 📅 2026-08-06 - Definition of the RISC-V processor instruction set architecture and extensions.
...
* [Official Coq wiki](https://github.com/coq/coq/wiki) ⭐ 5,553 | 🐛 2,575 | 🌐 OCaml | 📅 2026-08-03
* [Mathematical Components wiki](https://github.com/math-comp/math-comp/wiki) ⭐ 694 | 🐛 182 | 🌐 Rocq Prover | 📅 2026-08-05
...
* [Modeling and Proving in Computational Type Theory](https://github.com/uds-psl/MPCTT) ⭐ 124 | 🐛 0 | 🌐 Rocq Prover | 📅 2026-08-11 - Book covering topics in computational logic using Coq, including foundations, canonical case studies, and practical programming.
* [Hydras & Co.](https://github.com/coq-community/hydra-battles) ⭐ 83 | 🐛 13 | 🌐 Coq | 📅 2025-01-22 - Continuously in-progress book and library on Kirby and Paris' hydra battles and other entertaining formalized mathematics in Coq, including a proof of the Gödel-Rosser first incompleteness theorem.
...
* [Lectures on Software Foundations](https://github.com/clarksmr/sf-lectures) ⭐ 159 | 🐛 0 | 🌐 HTML | 📅 2024-04-30 - Material on the Software Foundations series of textbooks, including a series of YouTube videos.
...
* [Program Logics](https://github.com/xavierleroy/cdf-program-logics) ⭐ 44 | 🐛 0 | 🌐 Coq | 📅 2021-04-14 - Companion Coq sources for a course on program logics at Collège de France.
