...
* [VsCoq](https://github.com/coq-community/vscoq) ⭐ 461 | 🐛 168 | 🌐 Rocq Prover | 📅 2026-09-05 - Language server and extension for the Visual Studio Code and VSCodium editors.
* [VsCoq Legacy](https://github.com/coq-community/vscoq/tree/vscoq1) ⭐ 461 | 🐛 168 | 🌐 Rocq Prover | 📅 2026-09-05 - Backwards-compatible extension for the Visual Studio Code and VSCodium editors using Coq's legacy XML protocol.
...
* [Tree Sitter Rocq](https://github.com/lamg/tree-sitter-rocq) ⭐ 5 | 🐛 0 | 🌐 Rocq Prover | 📅 2025-08-17 - Partial Rocq tree-sitter grammar useful for syntax highlighting in text editors like [Helix](https://github.com/helix-editor/helix) ⭐ 46,167 | 🐛 1,650 | 🌐 Rust | 📅 2026-09-08, but not recommended for full parsing of Rocq code.
...
* [CoqHammer](https://github.com/lukaszcz/coqhammer) ⭐ 246 | 🐛 9 | 🌐 OCaml | 📅 2026-08-31 - General-purpose automated reasoning hammer tool that combines learning from previous proofs with the translation of problems to automated provers and the reconstruction of found proofs.
* [Equations](https://github.com/mattam82/Coq-Equations) ⭐ 236 | 🐛 98 | 🌐 Rocq Prover | 📅 2026-09-10 - Function definition package for Coq.
* [Coq-Elpi](https://github.com/LPCIC/coq-elpi) ⭐ 195 | 🐛 129 | 🌐 OCaml | 📅 2026-09-07 - Extension framework based on λProlog providing an extensive API to implement commands and tactics.
* [SMTCoq](https://github.com/smtcoq/smtcoq) ⭐ 170 | 🐛 44 | 🌐 OCaml | 📅 2026-09-09 - Tool that checks proof witnesses coming from external SAT and SMT solvers.
...
* [Ott](https://github.com/ott-lang/ott) ⭐ 420 | 🐛 39 | 🌐 OCaml | 📅 2026-09-10 - Tool for writing definitions of programming languages and calculi that can be translated to Coq.
...
* [Homotopy Type Theory](https://github.com/HoTT/Coq-HoTT) ⭐ 1,406 | 🐛 136 | 🌐 Rocq Prover | 📅 2026-09-10 - Development of homotopy-theoretic ideas.
* [UniMath](https://github.com/UniMath/UniMath) ⭐ 1,018 | 🐛 152 | 🌐 Rocq Prover | 📅 2026-09-05 - Library which aims to formalize a substantial body of mathematics using the univalent point of view.
* [Category Theory in Coq](https://github.com/jwiegley/category-theory) ⭐ 808 | 🐛 630 | 🌐 Rocq Prover | 📅 2026-09-10 - Axiom-free formalization of category theory.
...
* [Analysis](https://github.com/math-comp/analysis) ⭐ 247 | 🐛 178 | 🌐 Rocq Prover | 📅 2026-09-09 - Library for classical real analysis compatible with Mathematical Components.
...
* [CoqPrime](https://github.com/thery/coqprime) ⭐ 44 | 🐛 2 | 🌐 Rocq Prover | 📅 2026-09-10 - Library for certifying primality using Pocklington and Elliptic Curve certificates.
...
* [Fiat-Crypto](https://github.com/mit-plv/fiat-crypto) ⭐ 839 | 🐛 214 | 🌐 Rocq Prover | 📅 2026-09-10 - Cryptographic primitive code generation.
* [Jasmin](https://github.com/jasmin-lang/jasmin) ⭐ 364 | 🐛 141 | 🌐 Rocq Prover | 📅 2026-09-10 - Formalized language and verified compiler for high-assurance and high-speed cryptography.
...
* [Official Coq wiki](https://github.com/coq/coq/wiki) ⭐ 5,570 | 🐛 2,524 | 🌐 OCaml | 📅 2026-09-10
