...
[<img src="coq-logo.svg" align="right" width="100" alt="coq-community logo" title="Awesome Coq is a coq-community project">](https://github.com/coq-community/manifesto) ⭐ 75 | 🐛 40 | 📅 2025-03-31
...
Contributions welcome! Read the [contribution guidelines](https://github.com/coq-community/awesome-coq/blob/master/CONTRIBUTING.md) ⭐ 396 | 🐛 10 | 📅 2026-06-05 first.
...
* [FCF](https://github.com/adampetcher/fcf) ⭐ 57 | 🐛 7 | 🌐 Rocq Prover | 📅 2025-10-02 - Framework for proofs of cryptography.
...
* [VCFloat](https://github.com/VeriNum/vcfloat) ⭐ 33 | 🐛 5 | 🌐 Rocq Prover | 📅 2026-09-23 - Framework for verifying C programs with floating-point computations.
...
* [VsCoq](https://github.com/coq-community/vscoq) ⭐ 461 | 🐛 171 | 🌐 Rocq Prover | 📅 2026-09-22 - Language server and extension for the Visual Studio Code and VSCodium editors.
* [VsCoq Legacy](https://github.com/coq-community/vscoq/tree/vscoq1) ⭐ 461 | 🐛 171 | 🌐 Rocq Prover | 📅 2026-09-22 - Backwards-compatible extension for the Visual Studio Code and VSCodium editors using Coq's legacy XML protocol.
...
* [Coq LSP](https://github.com/ejgallego/coq-lsp) ⭐ 208 | 🐛 153 | 🌐 OCaml | 📅 2026-09-24 - Language server and extension for the Visual Studio Code and VSCodium editors with custom document checking engine.
...
* [Tree Sitter Rocq](https://github.com/lamg/tree-sitter-rocq) ⭐ 5 | 🐛 0 | 🌐 Rocq Prover | 📅 2025-08-17 - Partial Rocq tree-sitter grammar useful for syntax highlighting in text editors like [Helix](https://github.com/helix-editor/helix) ⭐ 46,322 | 🐛 1,682 | 🌐 Rust | 📅 2026-09-22, but not recommended for full parsing of Rocq code.
...
* [Interaction Trees](https://github.com/DeepSpec/InteractionTrees) ⭐ 258 | 🐛 30 | 🌐 Rocq Prover | 📅 2026-06-12 - Library for representing recursive and impure programs.
...
* [MathComp Extra](https://github.com/thery/mathcomp-extra) ⭐ 5 | 🐛 1 | 🌐 Rocq Prover | 📅 2026-09-12 - Extra material for the Mathematical Components library, including the AKS primality test and RSA encryption and decryption.
...
* [Coq Nix Toolbox](https://github.com/coq-community/coq-nix-toolbox) ⭐ 57 | 🐛 41 | 🌐 Nix | 📅 2026-09-22 - Nix helper scripts to automate local builds and continuous integration for Coq.
...
* [MetaCoq](https://github.com/MetaCoq/metacoq) ⭐ 554 | 🐛 97 | 🌐 Rocq Prover | 📅 2026-09-22 - Project formalizing Coq in Coq and providing tools for manipulating Coq terms and developing certified plugins.
...
* [Equations](https://github.com/mattam82/Coq-Equations) ⭐ 236 | 🐛 100 | 🌐 Rocq Prover | 📅 2026-09-22 - Function definition package for Coq.
* [Coq-Elpi](https://github.com/LPCIC/coq-elpi) ⭐ 194 | 🐛 138 | 🌐 OCaml | 📅 2026-09-22 - Extension framework based on λProlog providing an extensive API to implement commands and tactics.
...
* [coq-tools](https://github.com/JasonGross/coq-tools) ⭐ 48 | 🐛 58 | 🌐 Python | 📅 2026-07-30 - Scripts for manipulating Coq developments.
  * [`find-bug.py`](https://github.com/JasonGross/coq-tools/blob/master/find-bug.py) ⭐ 48 | 🐛 58 | 🌐 Python | 📅 2026-07-30 - Automatically minimizes source files producing an error, creating small test cases for Coq bugs.
  * [`absolutize-imports.py`](https://github.com/JasonGross/coq-tools/blob/master/absolutize-imports.py) ⭐ 48 | 🐛 58 | 🌐 Python | 📅 2026-07-30 - Processes source files to make loading of dependencies robust against shadowing of file names.
  * [`inline-imports.py`](https://github.com/JasonGross/coq-tools/blob/master/inline-imports.py) ⭐ 48 | 🐛 58 | 🌐 Python | 📅 2026-07-30 - Creates stand-alone source files from developments by inlining the loading of all dependencies.
  * [`minimize-requires.py`](https://github.com/JasonGross/coq-tools/blob/master/minimize-requires.py) ⭐ 48 | 🐛 58 | 🌐 Python | 📅 2026-07-30 - Removes loading of unused dependencies.
  * [`move-requires.py`](https://github.com/JasonGross/coq-tools/blob/master/move-requires.py) ⭐ 48 | 🐛 58 | 🌐 Python | 📅 2026-07-30 - Moves all dependency loading statements to the top of source files.
  * [`move-vernaculars.py`](https://github.com/JasonGross/coq-tools/blob/master/move-vernaculars.py) ⭐ 48 | 🐛 58 | 🌐 Python | 📅 2026-07-30 - Lifts many vernacular commands and inner lemmas out of proof script blocks.
  * [`proof-using-helper.py`](https://github.com/JasonGross/coq-tools/blob/master/proof-using-helper.py) ⭐ 48 | 🐛 58 | 🌐 Python | 📅 2026-07-30 - Modifies source files to include proof annotations for faster parallel proving.
...
* [Trakt](https://github.com/ecranceMERCE/trakt) ⭐ 17 | 🐛 2 | 🌐 Prolog | 📅 2026-09-09 - Generic goal preprocessing tool for proof automation tactics.
...
* [Category Theory in Coq](https://github.com/jwiegley/category-theory) ⭐ 812 | 🐛 612 | 🌐 Rocq Prover | 📅 2026-09-24 - Axiom-free formalization of category theory.
...
* [Analysis](https://github.com/math-comp/analysis) ⭐ 246 | 🐛 182 | 🌐 Rocq Prover | 📅 2026-09-23 - Library for classical real analysis compatible with Mathematical Components.
...
* [Monae](https://github.com/affeldt-aist/monae) ⭐ 77 | 🐛 28 | 🌐 Rocq Prover | 📅 2026-09-23 - Monadic effects and equational reasoning.
* [Infotheo](https://github.com/affeldt-aist/infotheo) ⭐ 76 | 🐛 25 | 🌐 Rocq Prover | 📅 2026-09-23 - Formalization of information theory and linear error-correcting codes.
...
* [CoqPrime](https://github.com/thery/coqprime) ⭐ 44 | 🐛 1 | 🌐 Rocq Prover | 📅 2026-09-13 - Library for certifying primality using Pocklington and Elliptic Curve certificates.
...
* [Fiat-Crypto](https://github.com/mit-plv/fiat-crypto) ⭐ 840 | 🐛 213 | 🌐 Rocq Prover | 📅 2026-09-24 - Cryptographic primitive code generation.
* [Jasmin](https://github.com/jasmin-lang/jasmin) ⭐ 367 | 🐛 155 | 🌐 Rocq Prover | 📅 2026-09-24 - Formalized language and verified compiler for high-assurance and high-speed cryptography.
...
* [Official Coq wiki](https://github.com/coq/coq/wiki) ⭐ 5,588 | 🐛 2,528 | 🌐 OCaml | 📅 2026-09-24
* [Mathematical Components wiki](https://github.com/math-comp/math-comp/wiki) ⭐ 697 | 🐛 177 | 🌐 Rocq Prover | 📅 2026-09-24
...
* [Modeling and Proving in Computational Type Theory](https://github.com/uds-psl/MPCTT) ⭐ 128 | 🐛 0 | 🌐 Rocq Prover | 📅 2026-08-11 - Book covering topics in computational logic using Coq, including foundations, canonical case studies, and practical programming.
