...
* [UniMath](https://github.com/UniMath/UniMath) ⭐ 1,018 | 🐛 151 | 🌐 Rocq Prover | 📅 2026-09-11 - Library which aims to formalize a substantial body of mathematics using the univalent point of view.
* [Category Theory in Coq](https://github.com/jwiegley/category-theory) ⭐ 808 | 🐛 624 | 🌐 Rocq Prover | 📅 2026-09-11 - Axiom-free formalization of category theory.
...
* [Analysis](https://github.com/math-comp/analysis) ⭐ 247 | 🐛 178 | 🌐 Rocq Prover | 📅 2026-09-11 - Library for classical real analysis compatible with Mathematical Components.
...
* [CoqPrime](https://github.com/thery/coqprime) ⭐ 44 | 🐛 1 | 🌐 Rocq Prover | 📅 2026-09-11 - Library for certifying primality using Pocklington and Elliptic Curve certificates.
