...
Contributions welcome! Read the [contribution guidelines](https://github.com/coq-community/awesome-coq/blob/master/CONTRIBUTING.md) ⭐ 395 | 🐛 10 | 📅 2026-06-05 first.
...
* [VsCoq](https://github.com/coq-community/vscoq) ⭐ 461 | 🐛 170 | 🌐 Rocq Prover | 📅 2026-09-14 - Language server and extension for the Visual Studio Code and VSCodium editors.
* [VsCoq Legacy](https://github.com/coq-community/vscoq/tree/vscoq1) ⭐ 461 | 🐛 170 | 🌐 Rocq Prover | 📅 2026-09-14 - Backwards-compatible extension for the Visual Studio Code and VSCodium editors using Coq's legacy XML protocol.
...
* [Tree Sitter Rocq](https://github.com/lamg/tree-sitter-rocq) ⭐ 5 | 🐛 0 | 🌐 Rocq Prover | 📅 2025-08-17 - Partial Rocq tree-sitter grammar useful for syntax highlighting in text editors like [Helix](https://github.com/helix-editor/helix) ⭐ 46,236 | 🐛 1,660 | 🌐 Rust | 📅 2026-09-08, but not recommended for full parsing of Rocq code.
...
* [Interaction Trees](https://github.com/DeepSpec/InteractionTrees) ⭐ 257 | 🐛 30 | 🌐 Rocq Prover | 📅 2026-06-12 - Library for representing recursive and impure programs.
...
* [Coq Platform](https://github.com/coq/platform) ⭐ 247 | 🐛 69 | 🌐 Shell | 📅 2026-07-30 - Curated collection of packages to support Coq use in industry, education, and research.
* [Coq Nix Toolbox](https://github.com/coq-community/coq-nix-toolbox) ⭐ 57 | 🐛 40 | 🌐 Nix | 📅 2026-09-11 - Nix helper scripts to automate local builds and continuous integration for Coq.
...
* [MetaCoq](https://github.com/MetaCoq/metacoq) ⭐ 552 | 🐛 95 | 🌐 Rocq Prover | 📅 2026-08-18 - Project formalizing Coq in Coq and providing tools for manipulating Coq terms and developing certified plugins.
...
* [CoqHammer](https://github.com/lukaszcz/coqhammer) ⭐ 247 | 🐛 9 | 🌐 OCaml | 📅 2026-08-31 - General-purpose automated reasoning hammer tool that combines learning from previous proofs with the translation of problems to automated provers and the reconstruction of found proofs.
* [Equations](https://github.com/mattam82/Coq-Equations) ⭐ 236 | 🐛 98 | 🌐 Rocq Prover | 📅 2026-09-11 - Function definition package for Coq.
* [Coq-Elpi](https://github.com/LPCIC/coq-elpi) ⭐ 197 | 🐛 132 | 🌐 OCaml | 📅 2026-09-15 - Extension framework based on λProlog providing an extensive API to implement commands and tactics.
* [SMTCoq](https://github.com/smtcoq/smtcoq) ⭐ 170 | 🐛 43 | 🌐 OCaml | 📅 2026-09-14 - Tool that checks proof witnesses coming from external SAT and SMT solvers.
...
* [Sail](https://github.com/rems-project/sail) ⭐ 933 | 🐛 300 | 🌐 Sail | 📅 2026-09-11 - Tool for specifying instruction set architecture (ISA) semantics of processors and generating Coq definitions.
* [Cosette](https://github.com/uwdb/Cosette) ⭐ 686 | 🐛 27 | 🌐 Lean | 📅 2024-12-18 - Automated solver for reasoning about SQL query equivalences.
* [Ott](https://github.com/ott-lang/ott) ⭐ 422 | 🐛 39 | 🌐 OCaml | 📅 2026-09-14 - Tool for writing definitions of programming languages and calculi that can be translated to Coq.
...
* [Rocqnavi](https://github.com/affeldt-aist/rocqnavi) ⭐ 4 | 🐛 15 | 🌐 OCaml | 📅 2026-09-09 - Fork of coq2html that adds indexes, clickable notations, Markdown and LaTeX formatting in comments, and more.
...
* [Homotopy Type Theory](https://github.com/HoTT/Coq-HoTT) ⭐ 1,406 | 🐛 135 | 🌐 Rocq Prover | 📅 2026-09-10 - Development of homotopy-theoretic ideas.
* [UniMath](https://github.com/UniMath/UniMath) ⭐ 1,018 | 🐛 151 | 🌐 Rocq Prover | 📅 2026-09-14 - Library which aims to formalize a substantial body of mathematics using the univalent point of view.
* [Category Theory in Coq](https://github.com/jwiegley/category-theory) ⭐ 810 | 🐛 620 | 🌐 Rocq Prover | 📅 2026-09-13 - Axiom-free formalization of category theory.
* [Four Color Theorem](https://github.com/coq-community/fourcolor) ⭐ 249 | 🐛 3 | 🌐 Rocq Prover | 📅 2026-08-20 - Formal proof of the Four Color Theorem, a landmark result of graph theory.
* [Analysis](https://github.com/math-comp/analysis) ⭐ 247 | 🐛 178 | 🌐 Rocq Prover | 📅 2026-09-14 - Library for classical real analysis compatible with Mathematical Components.
...
* [Fiat-Crypto](https://github.com/mit-plv/fiat-crypto) ⭐ 839 | 🐛 212 | 🌐 Rocq Prover | 📅 2026-09-15 - Cryptographic primitive code generation.
* [Jasmin](https://github.com/jasmin-lang/jasmin) ⭐ 365 | 🐛 148 | 🌐 Rocq Prover | 📅 2026-09-15 - Formalized language and verified compiler for high-assurance and high-speed cryptography.
...
* [RISC-V Specification in Coq](https://github.com/mit-plv/riscv-coq) ⭐ 119 | 🐛 10 | 🌐 Rocq Prover | 📅 2026-09-07 - Definition of the RISC-V processor instruction set architecture and extensions.
...
* [Stable sort algorithms in Coq](https://github.com/pi8027/stablesort) ⭐ 26 | 🐛 2 | 🌐 Rocq Prover | 📅 2026-09-15 - Generic and modular proofs of correctness, including stability, of mergesort functions.
...
* [Official Coq wiki](https://github.com/coq/coq/wiki) ⭐ 5,575 | 🐛 2,521 | 🌐 OCaml | 📅 2026-09-15
* [Mathematical Components wiki](https://github.com/math-comp/math-comp/wiki) ⭐ 697 | 🐛 178 | 🌐 Rocq Prover | 📅 2026-09-15
...
* [Modeling and Proving in Computational Type Theory](https://github.com/uds-psl/MPCTT) ⭐ 127 | 🐛 0 | 🌐 Rocq Prover | 📅 2026-08-11 - Book covering topics in computational logic using Coq, including foundations, canonical case studies, and practical programming.
