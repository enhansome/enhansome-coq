...
* [VsCoq](https://github.com/coq-community/vscoq) ⭐ 460 | 🐛 173 | 🌐 OCaml | 📅 2026-08-28 - Language server and extension for the Visual Studio Code and VSCodium editors.
* [VsCoq Legacy](https://github.com/coq-community/vscoq/tree/vscoq1) ⭐ 460 | 🐛 173 | 🌐 OCaml | 📅 2026-08-28 - Backwards-compatible extension for the Visual Studio Code and VSCodium editors using Coq's legacy XML protocol.
...
* [Tree Sitter Rocq](https://github.com/lamg/tree-sitter-rocq) ⭐ 5 | 🐛 0 | 🌐 Rocq Prover | 📅 2025-08-17 - Partial Rocq tree-sitter grammar useful for syntax highlighting in text editors like [Helix](https://github.com/helix-editor/helix) ⭐ 46,051 | 🐛 1,634 | 🌐 Rust | 📅 2026-08-25, but not recommended for full parsing of Rocq code.
...
* [Coq Nix Toolbox](https://github.com/coq-community/coq-nix-toolbox) ⭐ 57 | 🐛 40 | 🌐 Nix | 📅 2026-08-28 - Nix helper scripts to automate local builds and continuous integration for Coq.
...
* [Coq-Elpi](https://github.com/LPCIC/coq-elpi) ⭐ 194 | 🐛 131 | 🌐 OCaml | 📅 2026-08-25 - Extension framework based on λProlog providing an extensive API to implement commands and tactics.
* [SMTCoq](https://github.com/smtcoq/smtcoq) ⭐ 169 | 🐛 44 | 🌐 OCaml | 📅 2026-09-01 - Tool that checks proof witnesses coming from external SAT and SMT solvers.
...
* [Sail](https://github.com/rems-project/sail) ⭐ 928 | 🐛 303 | 🌐 Sail | 📅 2026-08-26 - Tool for specifying instruction set architecture (ISA) semantics of processors and generating Coq definitions.
...
* [UniMath](https://github.com/UniMath/UniMath) ⭐ 1,019 | 🐛 153 | 🌐 Rocq Prover | 📅 2026-08-07 - Library which aims to formalize a substantial body of mathematics using the univalent point of view.
* [Category Theory in Coq](https://github.com/jwiegley/category-theory) ⭐ 807 | 🐛 693 | 🌐 Rocq Prover | 📅 2026-09-01 - Axiom-free formalization of category theory.
...
* [Analysis](https://github.com/math-comp/analysis) ⭐ 247 | 🐛 179 | 🌐 Rocq Prover | 📅 2026-09-01 - Library for classical real analysis compatible with Mathematical Components.
...
* [Fiat-Crypto](https://github.com/mit-plv/fiat-crypto) ⭐ 839 | 🐛 190 | 🌐 Rocq Prover | 📅 2026-09-01 - Cryptographic primitive code generation.
...
* [CertiCoq](https://github.com/CertiCoq/certicoq) ⭐ 177 | 🐛 28 | 🌐 Rocq Prover | 📅 2026-07-22 - Verified compiler from Gallina, the internal language of Coq, down to CompCert's Clight language.
...
* [Official Coq wiki](https://github.com/coq/coq/wiki) ⭐ 5,561 | 🐛 2,568 | 🌐 OCaml | 📅 2026-09-01
