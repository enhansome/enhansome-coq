...
* [VsCoq](https://github.com/coq-community/vscoq) ⭐ 460 | 🐛 170 | 🌐 Rocq Prover | 📅 2026-09-02 - Language server and extension for the Visual Studio Code and VSCodium editors.
* [VsCoq Legacy](https://github.com/coq-community/vscoq/tree/vscoq1) ⭐ 460 | 🐛 170 | 🌐 Rocq Prover | 📅 2026-09-02 - Backwards-compatible extension for the Visual Studio Code and VSCodium editors using Coq's legacy XML protocol.
...
* [Coq LSP](https://github.com/ejgallego/coq-lsp) ⭐ 208 | 🐛 150 | 🌐 OCaml | 📅 2026-09-01 - Language server and extension for the Visual Studio Code and VSCodium editors with custom document checking engine.
...
* [Tree Sitter Rocq](https://github.com/lamg/tree-sitter-rocq) ⭐ 5 | 🐛 0 | 🌐 Rocq Prover | 📅 2025-08-17 - Partial Rocq tree-sitter grammar useful for syntax highlighting in text editors like [Helix](https://github.com/helix-editor/helix) ⭐ 46,063 | 🐛 1,638 | 🌐 Rust | 📅 2026-09-01, but not recommended for full parsing of Rocq code.
...
* [SMTCoq](https://github.com/smtcoq/smtcoq) ⭐ 169 | 🐛 44 | 🌐 OCaml | 📅 2026-09-02 - Tool that checks proof witnesses coming from external SAT and SMT solvers.
...
* [Category Theory in Coq](https://github.com/jwiegley/category-theory) ⭐ 807 | 🐛 683 | 🌐 Rocq Prover | 📅 2026-09-02 - Axiom-free formalization of category theory.
...
* [Analysis](https://github.com/math-comp/analysis) ⭐ 247 | 🐛 177 | 🌐 Rocq Prover | 📅 2026-09-02 - Library for classical real analysis compatible with Mathematical Components.
...
* [Fiat-Crypto](https://github.com/mit-plv/fiat-crypto) ⭐ 839 | 🐛 214 | 🌐 Rocq Prover | 📅 2026-09-02 - Cryptographic primitive code generation.
* [Jasmin](https://github.com/jasmin-lang/jasmin) ⭐ 362 | 🐛 136 | 🌐 Rocq Prover | 📅 2026-09-02 - Formalized language and verified compiler for high-assurance and high-speed cryptography.
...
* [Official Coq wiki](https://github.com/coq/coq/wiki) ⭐ 5,562 | 🐛 2,564 | 🌐 OCaml | 📅 2026-09-02
