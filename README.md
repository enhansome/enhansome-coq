...
* [Fiat](https://github.com/mit-plv/fiat) ⭐ 157 | 🐛 2 | 🌐 Rocq Prover | 📅 2026-06-19 - Mostly automated synthesis of correct-by-construction programs.
...
* [CoqEAL](https://github.com/CoqEAL/CoqEAL) ⭐ 74 | 🐛 8 | 🌐 Rocq Prover | 📅 2026-08-20 - Framework to ease change of data representations in proofs.
...
* [VCFloat](https://github.com/VeriNum/vcfloat) ⭐ 32 | 🐛 6 | 🌐 Rocq Prover | 📅 2026-06-18 - Framework for verifying C programs with floating-point computations.
...
* [Coq LSP](https://github.com/ejgallego/coq-lsp) ⭐ 208 | 🐛 149 | 🌐 OCaml | 📅 2026-08-21 - Language server and extension for the Visual Studio Code and VSCodium editors with custom document checking engine.
...
* [Tree Sitter Rocq](https://github.com/lamg/tree-sitter-rocq) ⭐ 5 | 🐛 0 | 🌐 Rocq Prover | 📅 2025-08-17 - Partial Rocq tree-sitter grammar useful for syntax highlighting in text editors like [Helix](https://github.com/helix-editor/helix) ⭐ 45,898 | 🐛 1,619 | 🌐 Rust | 📅 2026-08-18, but not recommended for full parsing of Rocq code.
...
* [Interaction Trees](https://github.com/DeepSpec/InteractionTrees) ⭐ 255 | 🐛 30 | 🌐 Rocq Prover | 📅 2026-06-12 - Library for representing recursive and impure programs.
...
* [Mczify](https://github.com/math-comp/mczify) ⭐ 30 | 🐛 5 | 🌐 Rocq Prover | 📅 2026-08-20 - Library enabling Micromega arithmetic solvers to work when using Mathematical Components number definitions.
...
* [Coq Nix Toolbox](https://github.com/coq-community/coq-nix-toolbox) ⭐ 56 | 🐛 40 | 🌐 Nix | 📅 2026-08-21 - Nix helper scripts to automate local builds and continuous integration for Coq.
...
* [MetaCoq](https://github.com/MetaCoq/metacoq) ⭐ 548 | 🐛 94 | 🌐 Rocq Prover | 📅 2026-08-18 - Project formalizing Coq in Coq and providing tools for manipulating Coq terms and developing certified plugins.
...
* [CoqHammer](https://github.com/lukaszcz/coqhammer) ⭐ 243 | 🐛 9 | 🌐 OCaml | 📅 2026-08-08 - General-purpose automated reasoning hammer tool that combines learning from previous proofs with the translation of problems to automated provers and the reconstruction of found proofs.
* [Equations](https://github.com/mattam82/Coq-Equations) ⭐ 236 | 🐛 103 | 🌐 Rocq Prover | 📅 2026-08-20 - Function definition package for Coq.
...
* [Sail](https://github.com/rems-project/sail) ⭐ 920 | 🐛 303 | 🌐 Sail | 📅 2026-08-18 - Tool for specifying instruction set architecture (ISA) semantics of processors and generating Coq definitions.
* [Cosette](https://github.com/uwdb/Cosette) ⭐ 686 | 🐛 27 | 🌐 Lean | 📅 2024-12-18 - Automated solver for reasoning about SQL query equivalences.
* [Ott](https://github.com/ott-lang/ott) ⭐ 417 | 🐛 39 | 🌐 OCaml | 📅 2026-03-10 - Tool for writing definitions of programming languages and calculi that can be translated to Coq.
...
* [Homotopy Type Theory](https://github.com/HoTT/Coq-HoTT) ⭐ 1,403 | 🐛 136 | 🌐 Rocq Prover | 📅 2026-08-21 - Development of homotopy-theoretic ideas.
* [UniMath](https://github.com/UniMath/UniMath) ⭐ 1,017 | 🐛 152 | 🌐 Rocq Prover | 📅 2026-08-07 - Library which aims to formalize a substantial body of mathematics using the univalent point of view.
* [Category Theory in Coq](https://github.com/jwiegley/category-theory) ⭐ 805 | 🐛 725 | 🌐 Rocq Prover | 📅 2026-08-21 - Axiom-free formalization of category theory.
* [Analysis](https://github.com/math-comp/analysis) ⭐ 247 | 🐛 184 | 🌐 Rocq Prover | 📅 2026-08-20 - Library for classical real analysis compatible with Mathematical Components.
...
* [Fiat-Crypto](https://github.com/mit-plv/fiat-crypto) ⭐ 839 | 🐛 187 | 🌐 Rocq Prover | 📅 2026-08-19 - Cryptographic primitive code generation.
* [Jasmin](https://github.com/jasmin-lang/jasmin) ⭐ 362 | 🐛 135 | 🌐 Rocq Prover | 📅 2026-08-21 - Formalized language and verified compiler for high-assurance and high-speed cryptography.
...
* [CertiCoq](https://github.com/CertiCoq/certicoq) ⭐ 175 | 🐛 28 | 🌐 Rocq Prover | 📅 2026-07-22 - Verified compiler from Gallina, the internal language of Coq, down to CompCert's Clight language.
...
* [Stable sort algorithms in Coq](https://github.com/pi8027/stablesort) ⭐ 25 | 🐛 2 | 🌐 Rocq Prover | 📅 2026-08-21 - Generic and modular proofs of correctness, including stability, of mergesort functions.
...
* [Official Coq wiki](https://github.com/coq/coq/wiki) ⭐ 5,550 | 🐛 2,575 | 🌐 OCaml | 📅 2026-08-21
* [Mathematical Components wiki](https://github.com/math-comp/math-comp/wiki) ⭐ 695 | 🐛 177 | 🌐 Rocq Prover | 📅 2026-08-20
...
* [Hydras & Co.](https://github.com/coq-community/hydra-battles) ⭐ 80 | 🐛 13 | 🌐 Coq | 📅 2025-01-22 - Continuously in-progress book and library on Kirby and Paris' hydra battles and other entertaining formalized mathematics in Coq, including a proof of the Gödel-Rosser first incompleteness theorem.
