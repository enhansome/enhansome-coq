...
* [VsCoq](https://github.com/coq-community/vscoq) ⭐ 460 | 🐛 174 | 🌐 OCaml | 📅 2026-08-28 - Language server and extension for the Visual Studio Code and VSCodium editors.
* [VsCoq Legacy](https://github.com/coq-community/vscoq/tree/vscoq1) ⭐ 460 | 🐛 174 | 🌐 OCaml | 📅 2026-08-28 - Backwards-compatible extension for the Visual Studio Code and VSCodium editors using Coq's legacy XML protocol.
...
* [Coq LSP](https://github.com/ejgallego/coq-lsp) ⭐ 208 | 🐛 150 | 🌐 OCaml | 📅 2026-08-21 - Language server and extension for the Visual Studio Code and VSCodium editors with custom document checking engine.
...
* [Tree Sitter Rocq](https://github.com/lamg/tree-sitter-rocq) ⭐ 5 | 🐛 0 | 🌐 Rocq Prover | 📅 2025-08-17 - Partial Rocq tree-sitter grammar useful for syntax highlighting in text editors like [Helix](https://github.com/helix-editor/helix) ⭐ 45,971 | 🐛 1,631 | 🌐 Rust | 📅 2026-08-25, but not recommended for full parsing of Rocq code.
...
* [Coq Nix Toolbox](https://github.com/coq-community/coq-nix-toolbox) ⭐ 56 | 🐛 40 | 🌐 Nix | 📅 2026-08-28 - Nix helper scripts to automate local builds and continuous integration for Coq.
...
* [CoqHammer](https://github.com/lukaszcz/coqhammer) ⭐ 244 | 🐛 9 | 🌐 OCaml | 📅 2026-08-21 - General-purpose automated reasoning hammer tool that combines learning from previous proofs with the translation of problems to automated provers and the reconstruction of found proofs.
...
* [SMTCoq](https://github.com/smtcoq/smtcoq) ⭐ 169 | 🐛 44 | 🌐 OCaml | 📅 2026-08-28 - Tool that checks proof witnesses coming from external SAT and SMT solvers.
...
* [Unicoq](https://github.com/unicoq/unicoq) ⭐ 60 | 🐛 12 | 🌐 OCaml | 📅 2026-06-26 - Plugin that replaces the existing unification algorithm with an enhanced one.
...
* [Sail](https://github.com/rems-project/sail) ⭐ 925 | 🐛 303 | 🌐 Sail | 📅 2026-08-26 - Tool for specifying instruction set architecture (ISA) semantics of processors and generating Coq definitions.
...
* [Category Theory in Coq](https://github.com/jwiegley/category-theory) ⭐ 806 | 🐛 712 | 🌐 Rocq Prover | 📅 2026-08-28 - Axiom-free formalization of category theory.
...
* [Analysis](https://github.com/math-comp/analysis) ⭐ 247 | 🐛 185 | 🌐 Rocq Prover | 📅 2026-08-28 - Library for classical real analysis compatible with Mathematical Components.
...
* [Jasmin](https://github.com/jasmin-lang/jasmin) ⭐ 362 | 🐛 139 | 🌐 Rocq Prover | 📅 2026-08-28 - Formalized language and verified compiler for high-assurance and high-speed cryptography.
...
* [Official Coq wiki](https://github.com/coq/coq/wiki) ⭐ 5,558 | 🐛 2,568 | 🌐 OCaml | 📅 2026-08-28
* [Mathematical Components wiki](https://github.com/math-comp/math-comp/wiki) ⭐ 695 | 🐛 177 | 🌐 Rocq Prover | 📅 2026-08-28
