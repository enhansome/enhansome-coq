...
* [Tree Sitter Rocq](https://github.com/lamg/tree-sitter-rocq) ⭐ 5 | 🐛 0 | 🌐 Rocq Prover | 📅 2025-08-17 - Partial Rocq tree-sitter grammar useful for syntax highlighting in text editors like [Helix](https://github.com/helix-editor/helix) ⭐ 46,038 | 🐛 1,634 | 🌐 Rust | 📅 2026-08-25, but not recommended for full parsing of Rocq code.
...
* [CoqHammer](https://github.com/lukaszcz/coqhammer) ⭐ 244 | 🐛 9 | 🌐 OCaml | 📅 2026-08-31 - General-purpose automated reasoning hammer tool that combines learning from previous proofs with the translation of problems to automated provers and the reconstruction of found proofs.
...
* [Sail](https://github.com/rems-project/sail) ⭐ 927 | 🐛 303 | 🌐 Sail | 📅 2026-08-26 - Tool for specifying instruction set architecture (ISA) semantics of processors and generating Coq definitions.
...
* [UniMath](https://github.com/UniMath/UniMath) ⭐ 1,018 | 🐛 153 | 🌐 Rocq Prover | 📅 2026-08-07 - Library which aims to formalize a substantial body of mathematics using the univalent point of view.
* [Category Theory in Coq](https://github.com/jwiegley/category-theory) ⭐ 807 | 🐛 695 | 🌐 Rocq Prover | 📅 2026-08-31 - Axiom-free formalization of category theory.
...
* [Analysis](https://github.com/math-comp/analysis) ⭐ 247 | 🐛 182 | 🌐 Rocq Prover | 📅 2026-08-31 - Library for classical real analysis compatible with Mathematical Components.
...
* [Fiat-Crypto](https://github.com/mit-plv/fiat-crypto) ⭐ 839 | 🐛 188 | 🌐 Rocq Prover | 📅 2026-08-31 - Cryptographic primitive code generation.
* [Jasmin](https://github.com/jasmin-lang/jasmin) ⭐ 362 | 🐛 136 | 🌐 Rocq Prover | 📅 2026-08-31 - Formalized language and verified compiler for high-assurance and high-speed cryptography.
...
* [Official Coq wiki](https://github.com/coq/coq/wiki) ⭐ 5,561 | 🐛 2,574 | 🌐 OCaml | 📅 2026-08-28
